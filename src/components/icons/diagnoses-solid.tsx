...
export const icon = () => (
  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="diagnoses" className="svg-inline--fa fa-diagnoses fa-w-20" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
    <path
      fill="currentColor"
