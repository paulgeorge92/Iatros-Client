...
const ErrorPage500 = () => {
  return (
    <>
      <Layout className="full-page always-top">
        <Content>
          <Row style={{ backgroundImage: 'url(' + bg + ')', width: '100%' }} justify="space-around" align="middle">
            <Col xs={{ span: 20 }} md={{ span: 12 }} lg={{ span: 12 }} xl={{ span: 6 }} style={{ marginTop: 'calc(50vh - 220.3px)' }}>
              ...
              <p className="ant-result-title">500</p>
              <p className="ant-result-subtitle">Server is reporting some error</p>
            </Col>
          </Row>
        </Content>
      </Layout>
